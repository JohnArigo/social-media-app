...
export default function Index() {
  ...
  return (
    <main className="w-screen h-screen">
      ...
      <section className="w-full h-2/3 bg-gray-50 text-slate-900 flex justify-center items-center z-40">
        <TransitionY execute={transitionOne}>
          <div className="h-2/3 w-full flex justify-around mt-10 z-40">
            ...
            <div className="w-1/4 h-full flex flex-col items-center z-40">
      ...
      <section className="w-full text-white h-5/6 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-slate-200 via-accent-500 to-gray-500 flex justify-center items-center z-40">
